...
export default class LanguageService implements ILanguageService {
  ...
  constructor() {
    ...
    this.getLanguageByIdUseCase = new GetLanguageByIdUseCase(
      languageRepository
    );
    this.getLanguageByNameUseCase = new GetLanguageByNameUseCase(
      languageRepository
    );
    this.getAllLanguagesUseCase = new GetAllLanguagesUseCase(
      languageRepository
    );
