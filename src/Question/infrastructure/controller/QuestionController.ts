...
export async function createQuestion(req: Request, res: Response) {
    try {
        ...
        const result = await questionService.createQuestion(languageId, descriptions);
        if (result) {
...
export async function getQuestionsByLanguageId(req: Request, res: Response) {
    try {
        ...
        const questions = await questionService.findQuestionsByLanguageId(languageId);
...
export async function updateQuestion(req: Request, res: Response) {
    try {
        const { id } = req.params;
        const { languageId, descriptions } = req.body;
        const result = await questionService.updateQuestion(id, languageId, descriptions);
        if (result) {
