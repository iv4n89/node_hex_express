...
export default class FindByQuestionsIdUseCase extends UseCaseBase<string, Array<Review>> {
    constructor(private readonly reviewRepository: IReviewRepository, private readonly questionsRepository: IQuestionRepository) { super(); }
